...
import (
	...
	"github.com/opentofu/opentofu/internal/hof/cmd/hof/cmd/mod"
...
//   i.e. github.com/opentofu/opentofu/internal/hof
module: "<module-path>"
cue: "v0.5.0"
...
replace: {
  ...
  "github.com/opentofu/opentofu/internal/hofmod-cli": "../mods/clie"
}
---
...
# Add a dependency
hof mod get github.com/opentofu/opentofu/internal/hof@v0.6.8
hof mod get github.com/opentofu/opentofu/internal/hof@v0.6.8-beta.6
hof mod get github.com/opentofu/opentofu/internal/hof@latest   // latest semver
hof mod get github.com/opentofu/opentofu/internal/hof@next     // next prerelease
hof mod get github.com/opentofu/opentofu/internal/hof@main     // latest commit on branch

# Update dependencies
hof mod get github.com/opentofu/opentofu/internal/hof@latest
