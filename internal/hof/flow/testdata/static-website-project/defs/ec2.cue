...
ec2: schemas.#ModuleEC2 & {
    ...
    subnet_id:              string @runinject(public_subnet_id)
    rds_endpoint:           string @runinject(rds_endpoint)
    user_data: """
        #!/bin/bash
        ...
        echo "\(rds_endpoint)" > /home/ec2-user/rds_endpoint.txt
